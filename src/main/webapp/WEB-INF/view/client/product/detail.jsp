                            ...
                            <div>
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">Chi Tiết Sản Pẩm</li>
                                    </ol>
                                </nav>
                            </div>
                            <div class="col-lg-8 col-xl-9">
                                <div class="row g-4">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <form action="/add-product-to-from-view-detail" method="post"
                                ...
                                <c:forEach var="listProduct" items="${listProduct}">
                                    <div class="border border-primary rounded position-relative vesitable-item">
                                        <div class="vesitable-img">
                                            <img src="/images/product/${listProduct.image}"
                                                class="img-fluid w-100 rounded-top" alt="">
                                        </div>
                                        <div class="text-white bg-primary px-3 py-1 rounded position-absolute"
                                            style="top: 10px; right: 10px;">Laptop</div>
                                        <div class="p-4 border border-secondary border-top-0 rounded-bottom">
                                            <a href="/product/${listProduct.id}">
                                                ${listProduct.name}
                                            </a>
                                            <p style="font-size: 13px;">${listProduct.shortDesc}</p>
                                            <div class="d-flex flex-lg-wrap justify-content-center flex-column">
                                                <p style="font-size:15px; text-align: center; width:100%;"
                                                    class="text-dark fw-bold mb-3">
                                                    <fmt:formatNumber type="number" value="${listProduct.price}" /> đ
                                                </p>

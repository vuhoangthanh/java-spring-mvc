                        ...
                        <div class="container py-5">
                            <div class="p-5 bg-light rounded">
                                <div class="row g-4">
                                    ...
                                    <form:form method="post" action="/info/update" enctype="multipart/form-data"
                                        modelAttribute="user">
                                        <div class=" row">
                                            <div class="col-lg-5">
                                                <div class="d-flex align-items-center">
                                                    <img src="/images/avatar/${user.avatar}"
                                                        ...
                                                        style="width: 75%; height: 330px;" alt="" id="avatarPreview">
                                                </div>
                                                <input class="form-control mt-5 " type="file" id="avatarFile"
                                        ...
                                        <button class="btn btn-primary" type="submit" style="margin-right:50px;">Cập
                                            nhật</button>
                                    </form:form>
                                </div>
                            </div>
